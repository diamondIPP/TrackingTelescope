...
class PLTTrack
{
  public:
    ...
    float ExtrapolateX(float Z){return (Z * fSlopeRadX) + fOffsetX;}
    float ExtrapolateY(float Z){return (Z * fSlopeRadY) + fOffsetY;}
  ...
  public:
    ...
    float fSlopeX, fSlopeY, fOffsetX, fOffsetY, fSlopeRadX, fSlopeRadY;
