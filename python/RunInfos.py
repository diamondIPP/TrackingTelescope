...
# di_li_runs_up_less has lists of runs while increasing the flux (only three runs)
# di_li_runs_down has lists of runs while decreasing the flux
# di_li_runs_down_less has lists of runs while decreasing the flux (only three runs)
# di_li_runs_down_extended has lists of runs while decreasing the flux including the last up-run
...
di_li_runs_up_less = {}
di_li_runs_down = {}
di_li_runs_down_less = {}
di_li_runs_down_extended = {}
di_li_runs_final = {}
di_di_rocs = {}
...
di_li_runs_up[0] = [316]
di_li_runs_up_less[0] = [316]
di_li_runs_down[0] = []
di_li_runs_down_less[0] = []
di_li_runs_down_extended[0] = [316]
di_li_runs_final[0] = []
di_di_rocs[0] = {0 : "Si",
                 1 : "PolyA", 
                 2 : "PolyD", 
...
di_li_runs_up_less[1] = [322, 327, 333]
di_li_runs_down[1] = [338, 340, 343, 347, 348]
di_li_runs_down_less[1] = [347,340,333 ]
di_li_runs_down_extended[1] = [333, 338, 340, 343, 347, 348]
...
di_li_runs_up[2] = [475, 467, 469, 470,473, 478]
di_li_runs_up_less[2] = [466, 469, 470]
di_li_runs_down[2] = [471, 472, 473, 474, 475]
di_li_runs_down_less[2] = [475, 473, 470 ]
di_li_runs_down_extended[2] = [470, 471, 472, 473, 474, 475]
